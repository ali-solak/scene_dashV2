...
void spawnWaveCrash(
  ...
  final spray = fx.ParticleSystem(
    ...
    modules: [
      // Swells on the throw, then shrinks to nothing: a droplet breaking up
      // rather than a dot that simply fades.
      fx.SizeOverLifeModule(
        fx.CurveFloat(
          fx.ParticleCurve([
            const fx.ParticleKeyframe(0, 0.75),
            const fx.ParticleKeyframe(0.18, 1.15),
