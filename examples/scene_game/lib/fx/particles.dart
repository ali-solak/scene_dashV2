/// The game's single import surface for flutter_scene's particle system.
///
/// flutter_scene 0.19 ships `ParticleEmitterComponent` and its
/// configuration types under `lib/src/` only — upstream's own
/// `TODO(particles)` defers barreling them until the authoring API settles.
/// Concentrating the implementation imports here keeps the exception to one
/// file; when upstream exports them from `package:flutter_scene/scene.dart`,
/// this file's exports flip to the barrel and nothing else changes
/// (backlog row).
///
